    ...
    CreateCategory: {
      ...
      resolve(
        ...
        return __awaiter(this, void 0, void 0, function* () {
          const { rows } = yield (0, database_1.query)(
      ...
      resolve(
        ...
        return __awaiter(this, void 0, void 0, function* () {
          ...
          try {
            ...
            const { rows } = yield client.query(QueryString.InsertAttribute(), [
              product_uid,
              attribute_name,
            ]);
            ...
            try {
              for (
                options_1 = __asyncValues(options);
                (options_1_1 = yield options_1.next()), !options_1_1.done;
