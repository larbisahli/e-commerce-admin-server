...
const DeleteTemporaryImages = (TemporaryImages) => { var TemporaryImages_1, TemporaryImages_1_1; return __awaiter(void 0, void 0, void 0, function* () {
    var e_1, _a;
    try {
        try {
            for (TemporaryImages_1 = __asyncValues(TemporaryImages); TemporaryImages_1_1 = yield TemporaryImages_1.next(), !TemporaryImages_1_1.done;) {
            ...
            try {
                if (TemporaryImages_1_1 && !TemporaryImages_1_1.done && (_a = TemporaryImages_1.return)) yield _a.call(TemporaryImages_1);
            }
        ...
        const params = [
            {
                ...
                Key: `${Year}/${Month}/${respond === null || respond === void 0 ? void 0 : respond.image.name}`,
                Body: fs_1.default.createReadStream(respond === null || respond === void 0 ? void 0 : respond.image.path),
                ACL: 'public-read',
            },
            {
                Bucket: process.env.SPACES_BUCKET_NAME,
                Key: `${Year}/${Month}/${respond === null || respond === void 0 ? void 0 : respond.placeholder.name}`,
                Body: fs_1.default.createReadStream(respond === null || respond === void 0 ? void 0 : respond.placeholder.path),
                ACL: 'public-read',
            },
        ];
        return yield Promise.all(params.map((param) => s3.putObject(param).promise()));
    });
}
function UploadImageByUrl(url, title) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const CleanTitle = title
            ...
            .replace(/\,/g, '')
            .replace(/\-/g, '');
        const imageName = `${CleanTitle.split(' ').join('_')}_${DateAsInt}_${shortid_1.default.generate()}`;
        return new Promise((resolve, reject) => {
            ...
            if (IsBase64Regex.test(url)) {
                ...
                const FileExtension = (_a = base64MimeType(url)) === null || _a === void 0 ? void 0 : _a.split('/')[1];
                ...
                fs_1.default.writeFile(Base64ImagePath, base64Data, 'base64', function (error) {
                    return __awaiter(this, void 0, void 0, function* () {
                        if (error) {
                            return reject({ error });
                        }
                        (0, sharp_1.default)(Base64ImagePath)
                            .resize(16)
                            .toFile(path_1.default.join('temp', Placeholder), (error) => __awaiter(this, void 0, void 0, function* () {
                            if (error) {
            ...
            .then((respond) => __awaiter(this, void 0, void 0, function* () {
