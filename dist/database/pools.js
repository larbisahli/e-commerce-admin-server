...
exports.DeletePool = exports.UpdatePool = exports.CreatePool = exports.ReadPool = void 0;
const pg_1 = require("pg");
const dotenv_1 = __importDefault(require("dotenv"));
dotenv_1.default.config();
const { POSTGRES_CREATE_USER_DEV_PASS, POSTGRES_CREATE_USER_DEV, POSTGRES_CREATE_USER_PASS, POSTGRES_CREATE_USER, POSTGRES_DELETE_USER_DEV_PASS, POSTGRES_DELETE_USER_DEV, POSTGRES_DELETE_USER_PASS, POSTGRES_DELETE_USER, POSTGRES_READ_USER_DEV_PASS, POSTGRES_READ_USER_DEV, POSTGRES_READ_USER_PASS, POSTGRES_READ_USER, POSTGRES_UPDATE_USER_DEV_PASS, POSTGRES_UPDATE_USER_DEV, POSTGRES_UPDATE_USER_PASS, POSTGRES_UPDATE_USER, POSTGRES_HOST_PROD, POSTGRES_HOST_DEV, POSTGRES_DEV_DB, POSTGRES_PORT, POSTGRES_DB, NODE_ENV, } = process.env;
